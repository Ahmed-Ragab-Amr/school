    ...
    <header>
        ...
        <div id="sidebar">
            ...
            <div class="btn-conteiner">
                <a class="btn-content" href="{{ route('student.show') }}">
                  <span class="btn-title">تصفح الطلاب</span>
...
<div id="section">
    ...
    <section>
        <div class="upload-container">
            <img src="{{ asset('user/images/Img_box_fill.png') }}" alt="Upload Icon" class="upload-icon">
            <span class="upload-text">أضف بيانات من ملف نصي أو صورة</span>
            <form action="{{ route('homework.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="d-flex">
                    <label for="browse-button" class="browse-button">تصفح</label>
                    <input type="file" name="file_path[]" multiple id="browse-button" class="browse-input" hidden>
                    <input type="submit" value="ارفق الملف" class="browse-button" style="margin-top: 20px;">
                </div>
            </form>
        </div>
    </section>
    ...
    <section class="image-gallery">
        ...
        <div class="image-container">
            ...
            <div class="icons">
                ...
                <form action="{{ route('homework.delete' , ['id'=>$homework->id , 'index'=>$index]) }}" method="post">
                    @csrf
                    @method('delete')
                     <button style="background-color: transparent; border: none; outline: none;" type="submit">
                        <i class="fas fa-trash icon-delete"
                        style="background: #000000; border-radius: 50%; padding: 10px;"></i>
                     </button>
                </form>
            </div>
    ...
    <section>
        <div class="upload-container">
            ...
            <form action="{{ route('cv.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="d-flex">
                  <label for="browse-button1" class="browse-button">تصفح</label>
                  <input type="file" name="file_path[]" multiple id="browse-button1" class="browse-input" hidden>
                  <input type="submit" value="ارفق الملف" class="browse-button" style="margin-top: 20px;">
                </div>
            </form>
        </div>
    ...
    <section class="image-gallery">
        ...
        <div class="image-container">
            ...
            <div class="icons">
                ...
                <form action="{{ route('cv.delete' , ['id'=>$cv->id , 'index'=>$index]) }}" method="post">
                    @csrf
                    @method('delete')
                     <button style="background-color: transparent; border: none; outline: none;" type="submit">
                        <i class="fas fa-trash icon-delete"
    ...
    <section>
        <div class="upload-container">
            ...
            <form action="{{ route('table.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="d-flex">
                  <label for="browse-button2" class="browse-button">تصفح</label>
                  <input type="file" name="file_path[]" multiple id="browse-button2" class="browse-input" hidden>
                  <input type="submit" value="ارفق الملف" class="browse-button" style="margin-top: 20px;">
                </div>
            </form>
        </div>
    ...
    <section class="image-gallery">
        ...
        <div class="image-container">
            ...
            <div class="icons">
                ...
                <form action="{{ route('table.delete' , ['id'=>$table->id , 'index'=>$index]) }}" method="post">
                    @csrf
                    @method('delete')
                     <button style="background-color: transparent; border: none; outline: none;" type="submit">
                        <i class="fas fa-trash icon-delete" style="background: #000000; border-radius: 50%; padding: 10px;"></i>
                     </button>
                </form>
            </div>
    ...
    <section>
        <div class="upload-container">
            ...
            <form action="{{ route('activity.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="d-flex">
                  <label for="browse-button3" class="browse-button">تصفح</label>
                  <input type="file" name="file_path[]" multiple id="browse-button3" class="browse-input" hidden>
                  <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                </div>
            </form>
        </div>
    ...
    <section class="image-gallery">
        ...
        <div class="image-container">
            ...
            <div class="icons">
                ...
                <form action="{{ route('activity.delete' , ['id'=>$activity->id , 'index'=>$index]) }}" method="post">
                    @csrf
                    @method('delete')
                     <button style="background-color: transparent; border: none; outline: none;" type="submit">
                        <i class="fas fa-trash icon-delete"
    ...
    <section>
        <div class="upload-container">
            ...
            <form action="{{ route('paperwork.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="d-flex">
                  <label for="browse-button4" class="browse-button">تصفح</label>
                  <input type="file" name="file_path[]" multiple id="browse-button4" class="browse-input" hidden>
                  <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                </div>
            </form>
        </div>
    ...
    <section class="image-gallery">
        ...
        <div class="image-container">
            ...
            <div class="icons">
                ...
                <form action="{{ route('paperwork.delete' , ['id'=>$paperwork->id , 'index'=>$index]) }}" method="post">
                    @csrf
                    @method('delete')
                     <button style="background-color: transparent; border: none; outline: none;" type="submit">
                        <i class="fas fa-trash icon-delete"
    ...
    <section>
        <div class="upload-container">
            ...
            <form action="{{ route('vision.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="d-flex">
                  <label for="browse-button5" class="browse-button">تصفح</label>
                  <input type="file" name="file_path[]" multiple id="browse-button5" class="browse-input" hidden>
                  <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                </div>
            </form>
        </div>
    ...
    <section class="image-gallery">
        ...
        <div class="image-container">
            ...
            <div class="icons">
                ...
                <form action="{{ route('vision.delete' , ['id'=>$vision->id , 'index'=>$index]) }}" method="post">
                    @csrf
                    @method('delete')
                     <button style="background-color: transparent; border: none; outline: none;" type="submit">
                        <i class="fas fa-trash icon-delete"
    ...
    <section>
        <div class="upload-container">
            ...
            <form action="{{ route('goal.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="d-flex">
                  <label for="browse-button6" class="browse-button">تصفح</label>
                  <input type="file" name="file_path[]" multiple id="browse-button6" class="browse-input" hidden>
                  <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                </div>
            </form>
        </div>
    ...
    <section class="image-gallery">
        ...
        <div class="image-container">
            ...
            <div class="icons">
                ...
                <form action="{{ route('goal.delete' , ['id'=>$goal->id , 'index'=>$index]) }}" method="post">
                    @csrf
                    @method('delete')
                     <button style="background-color: transparent; border: none; outline: none;" type="submit">
                        <i class="fas fa-trash icon-delete"
    ...
    <section>
        <div class="upload-container">
            ...
            <form action="{{ route('science.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="d-flex">
                  <label for="browse-button7" class="browse-button">تصفح</label>
                  <input type="file" name="file_path[]" multiple id="browse-button7" class="browse-input" hidden>
                  <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                </div>
            </form>
        </div>
    ...
    <section class="image-gallery">
        ...
        <div class="image-container">
            ...
            <div class="icons">
                ...
                <form action="{{ route('science.delete' , ['id'=>$science->id , 'index'=>$index]) }}" method="post">
                    @csrf
                    @method('delete')
                     <button style="background-color: transparent; border: none; outline: none;" type="submit">
                        <i class="fas fa-trash icon-delete"
...
<div id="sectionf">
    ...
    <section>
        <div class="upload-container">
            <img src="{{ asset('user/images/Img_box_fill.png') }}" alt="Upload Icon" class="upload-icon">
            <span class="upload-text">أضف بيانات من ملف نصي أو صورة</span>
            <form action="{{ route('plain.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="d-flex">
                  <label for="browse-button8" class="browse-button">تصفح</label>
                  <input type="file" name="file_path[]" multiple id="browse-button8" class="browse-input" hidden>
                  <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                </div>
            </form>
        </div>
    ...
    <section class="image-gallery">
        ...
        <div class="image-container">
            ...
            <div class="icons">
                ...
                <form action="{{ route('plain.delete' , ['id'=>$plain->id , 'index'=>$index]) }}" method="post">
                    @csrf
                    @method('delete')
                     <button style="background-color: transparent; border: none; outline: none;" type="submit">
                        <i class="fas fa-trash icon-delete"
    ...
    <section>
        <div class="upload-container">
            ...
            <form action="{{ route('english.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="d-flex">
                  <label for="browse-button9" class="browse-button">تصفح</label>
                  <input type="file" name="file_path[]" multiple id="browse-button9"  class="browse-input" hidden>
                  <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                </div>
            </form>
        </div>
    ...
    <section class="image-gallery">
        ...
        <div class="image-container">
            ...
            <div class="icons">
                ...
                <form action="{{ route('english.delete' , ['id'=>$english->id , 'index'=>$index]) }}" method="post">
                    @csrf
                    @method('delete')
                     <button style="background-color: transparent; border: none; outline: none;" type="submit">
                        <i class="fas fa-trash icon-delete"
    ...
    <section>
        <div class="upload-container">
            ...
            <form action="{{ route('other.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="d-flex">
                  <label for="browse-button12" class="browse-button">تصفح</label>
                  <input type="file" name="file_path[]" multiple id="browse-button12"  class="browse-input" hidden>
                  <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                </div>
            </form>
        </div>
    ...
    <section class="image-gallery">
        ...
        <div class="image-container">
            ...
            <div class="icons">
                ...
                <form action="{{ route('other.delete' , ['id'=>$other->id , 'index'=>$index]) }}" method="post">
                    @csrf
                    @method('delete')
                     <button style="background-color: transparent; border: none; outline: none;" type="submit">
                        <i class="fas fa-trash icon-delete"
...
<body>
        ...
        <section class="image-gallery">
            ...
            <div class="image-container">
                ...
                <div class="icons">
                    ...
                    <form action="{{ route('language.delete' , ['id'=>$language->id , 'index'=>$index]) }}" method="post">
                        @csrf
                        @method('delete')
                         <button style="background-color: transparent; border: none; outline: none;" type="submit">
                            <i class="fas fa-trash icon-delete"
    ...
    <div id="section3">
        ...
        <section>
            <div class="upload-container">
                <img src="{{ asset('user/images/Img_box_fill.png') }}" alt="Upload Icon" class="upload-icon">
                <span class="upload-text">أضف بيانات من ملف نصي أو صورة</span>
                <form action="{{ route('math.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                      <label for="browse-button6" class="browse-button">تصفح</label>
                      <input type="file" name="file_path[]" multiple id="browse-button6" class="browse-input" hidden>
        ...
        <section class="image-gallery">
            ...
            <div class="image-container">
                ...
                <div class="icons">
                    ...
                    <form action="{{ route('math.delete' , ['id'=>$math->id , 'index'=>$index]) }}" method="post">
                        @csrf
                        @method('delete')
                         <button style="background-color: transparent; border: none; outline: none;" type="submit">
                            <i class="fas fa-trash icon-delete"
    ...
    <div id="sectionf">
        ...
        <section>
            <div class="upload-container">
                <img src="{{ asset('user/images/Img_box_fill.png') }}" alt="Upload Icon" class="upload-icon">
                <span class="upload-text">أضف بيانات من ملف نصي أو صورة</span>
                <form action="{{ route('islamic.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                      <label for="browse-button8" class="browse-button">تصفح</label>
                      <input type="file" name="file_path[]" multiple id="browse-button8" class="browse-input" hidden>
        ...
        <section class="image-gallery">
            ...
            <div class="image-container">
                ...
                <div class="icons">
                    ...
                    <form action="{{ route('islamic.delete' , ['id'=>$islamic->id , 'index'=>$index]) }}" method="post">
                        @csrf
                        @method('delete')
                         <button style="background-color: transparent; border: none; outline: none;" type="submit">
                            <i class="fas fa-trash icon-delete"
        ...
        <section>
            <div class="upload-container">
                ...
                <form action="{{ route('skill.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                      <label for="browse-button10" class="browse-button">تصفح</label>
                      <input type="file" name="file_path[]" multiple id="browse-button10" class="browse-input" hidden>
                      <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                    </div>
                </form>
            </div>
        ...
        <section class="image-gallery">
            ...
            <div class="image-container">
                ...
                <div class="icons">
                    ...
                    <form action="{{ route('skill.delete' , ['id'=>$skill->id , 'index'=>$index]) }}" method="post">
                        @csrf
                        @method('delete')
                         <button style="background-color: transparent; border: none; outline: none;" type="submit">
                            <i class="fas fa-trash icon-delete"
    ...
    <div id="sectionh">
        ...
        <section>
            <div class="upload-container">
                ...
                <form action="{{ route('social.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                      <label for="browse-button11" class="browse-button">تصفح</label>
                      <input type="file" name="file_path[]" multiple id="browse-button11" class="browse-input" hidden>
                      <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                    </div>
                </form>
            </div>
        ...
        <section class="image-gallery">
            ...
            @foreach (json_decode($social->file_path) as $index => $file)
            ...
            <div class="image-container">
                ...
                <div class="icons">
                    ...
                    <form action="{{ route('social.delete' , ['id'=>$social->id , 'index'=>$index]) }}" method="post">
                        @csrf
                        @method('delete')
                         <button style="background-color: transparent; border: none; outline: none;" type="submit">
                            <i class="fas fa-trash icon-delete"
        ...
        <section class="image-gallery">
            ...
            <div class="image-container">
                ...
                <div class="icons">
                    ...
                    <form action="{{ route('homework.delete' , ['homework_id'=>$homework->id , 'index'=>$index]) }}" method="post">
                        @csrf
                        @method('delete')
                         <button style="background-color: transparent; border: none; outline: none;" type="submit">
                            <i class="fas fa-trash icon-delete"
        ...
        <section class="image-gallery">
            ...
            <div class="image-container">
                ...
                <div class="icons">
                    ...
                    <form action="{{ route('meeting.delete' , ['id'=>$meeting->id , 'index'=>$index]) }}" method="post">
                        @csrf
                        @method('delete')
                         <button style="background-color: transparent; border: none; outline: none;" type="submit">
                            <i class="fas fa-trash icon-delete"
...
@if(auth()->user()->user_type == 'التوجيه الطلابي')
        ...
        <section class="image-gallery">
            ...
            <div class="image-container">
                ...
                <div class="icons">
                    ...
                    <form action="{{ route('program.delete' , ['id'=>$program->id , 'index'=>$index]) }}" method="post">
                        @csrf
                        @method('delete')
                         <button style="background-color: transparent; border: none; outline: none;" type="submit">
                            <i class="fas fa-trash icon-delete"
        ...
        <section class="image-gallery">
            ...
            <div class="image-container">
                ...
                <div class="icons">
                    ...
                    <form action="{{ route('statistic.delete' , ['id'=>$statistic->id , 'index'=>$index]) }}" method="post">
                        @csrf
                        @method('delete')
                         <button style="background-color: transparent; border: none; outline: none;" type="submit">
                            <i class="fas fa-trash icon-delete"
        ...
        <section>
            <div class="upload-container">
                ...
                <form action="{{ route('situation.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                      <label for="browse-button13" class="browse-button">تصفح</label>
                      <input type="file" name="file_path[]" multiple id="browse-button13" class="browse-input" hidden>
                      <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                    </div>
                </form>
            </div>
        ...
        <section class="image-gallery">
            ...
            <div class="image-container">
                ...
                <div class="icons">
                    ...
                    <form action="{{ route('situation.delete' , ['id'=>$situation->id , 'index'=>$index]) }}" method="post">
                        @csrf
                        @method('delete')
                         <button style="background-color: transparent; border: none; outline: none;" type="submit">
                            <i class="fas fa-trash icon-delete"
        ...
        <section>
            <div class="upload-container">
                ...
                <form action="{{ route('guidance.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                      <label for="browse-button14" class="browse-button">تصفح</label>
                      <input type="file" name="file_path[]" multiple id="browse-button14" class="browse-input" hidden>
                      <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                    </div>
                </form>
            </div>
        ...
        <section class="image-gallery">
            ...
            <div class="image-container">
                ...
                <div class="icons">
                    ...
                    <form action="{{ route('guidance.delete' , ['id'=>$guidance->id , 'index'=>$index]) }}" method="post">
                        @csrf
                        @method('delete')
                         <button style="background-color: transparent; border: none; outline: none;" type="submit">
                            <i class="fas fa-trash icon-delete"
        ...
        <section>
            <div class="upload-container">
                ...
                <form action="{{ route('math.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                      <label for="browse-button15" class="browse-button">تصفح</label>
                      <input type="file" name="file_path[]" multiple id="browse-button15" class="browse-input" hidden>
                      <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                    </div>
                </form>
            </div>
        ...
        <section>
            <div class="upload-container">
                ...
                <form action="{{ route('social.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                      <label for="browse-button16" class="browse-button">تصفح</label>
                      <input type="file" name="file_path[]" multiple id="browse-button16" class="browse-input" hidden>
                      <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                    </div>
                </form>
            </div>
        ...
        <section>
            <div class="upload-container">
                ...
                <form action="{{ route('islamic.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                      <label for="browse-button17" class="browse-button">تصفح</label>
                      <input type="file" name="file_path[]" multiple id="browse-button17" class="browse-input" hidden>
                      <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                    </div>
                </form>
            </div>
        ...
        <section>
            <div class="upload-container">
                ...
                <form action="{{ route('skill.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                      <label for="browse-button18" class="browse-button">تصفح</label>
                      <input type="file" name="file_path[]" multiple id="browse-button18" class="browse-input" hidden>
                      <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                    </div>
                </form>
            </div>
        ...
        <section>
            <div class="upload-container">
                ...
                <form action="{{ route('student.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                      <label for="browse-button19" class="browse-button">تصفح</label>
                      <input type="file" name="file_path[]" multiple id="browse-button19" class="browse-input" hidden>
                      <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                    </div>
                </form>
            </div>
        ...
        <section class="image-gallery">
            ...
            <div class="image-container">
                ...
                <div class="icons">
                    ...
                    <form action="{{ route('student.delete' , ['id'=>$student->id , 'index'=>$index]) }}" method="post">
                        @csrf
                        @method('delete')
                         <button style="background-color: transparent; border: none; outline: none;" type="submit">
                            <i class="fas fa-trash icon-delete"
        ...
        <section>
            <div class="upload-container">
                ...
                <form action="{{ route('information.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                      <label for="browse-button20" class="browse-button">تصفح</label>
                      <input type="file" name="file_path[]" multiple id="browse-button20" class="browse-input" hidden>
                      <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                    </div>
                </form>
            </div>
        ...
        <section class="image-gallery">
            ...
            <div class="image-container">
                ...
                <div class="icons">
                    ...
                    <form action="{{ route('information.delete' , ['id'=>$information->id , 'index'=>$index]) }}" method="post">
                        @csrf
                        @method('delete')
                         <button style="background-color: transparent; border: none; outline: none;" type="submit">
                            <i class="fas fa-trash icon-delete"
        ...
        <section>
            <div class="upload-container">
                ...
                <form action="{{ route('other.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                      <label for="browse-button21" class="browse-button">تصفح</label>
                      <input type="file" name="file_path[]" multiple id="browse-button21" class="browse-input" hidden>
                      <input type="submit" value="ارفق الملف" class="browse-button"  style="margin-top: 20px;">
                    </div>
                </form>
            </div>
...
@if(auth()->user()->user_type == 'الصحه المدرسيه')
...
@if(auth()->user()->user_type == 'مصادر التعلم')
...
@if(auth()->user()->user_type == 'الامن والسلامه')
