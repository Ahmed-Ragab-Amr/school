  ...
  <body>
    <div class="container">
      ...
      <form action="{{ route('user.login') }}" method="POST">
        ...
        <div class="mb-3">
          <label for="national_id" class="form-label">رقم الهويه</label>
          <input type="text" class="form-control" name="national_id" id="national_id" placeholder="أدخل رقم الهويه" aria-describedby="national_id" >
          <div id="national_id" class="form-text">لا تشارك الرقم القومي مع أي شخص آخر.</div>
        </div>
        ...
        <a type="submit" href="{{ route('admin.ShowLogin') }}" class="btn btn-primary w-100 mt-lg-3 okay">تسجيل الدخول الي صفحة الأدمن</a>
